...
| Procurement | Implemented for demonstration | Physical-goods Purchase Requests notify the exact Officer, partial Bids and protected quotation evidence remain comparable, justified Line Awards create supplier-grouped standard Purchase Orders, and Equipment procurement is visible from the simulated map. Supplier portal, scoring, services, and multi-currency remain excluded. |
